...
const ROLE_VIEWABLE_STATUSES: Record<string, CaseStatus[]> = {
  SALES: ['DOCUMENT_SUBMISSION_REQUIRED', 'SALES_REVIEW_REQUIRED', 'COMPLIANCE_REVIEW_REQUIRED', 'REVISION_REQUESTED', 'OPS_REVIEW_REQUIRED', 'COMPLETED', 'CLOSED'],
  COMPLIANCE: ['COMPLIANCE_REVIEW_REQUIRED', 'REVISION_REQUESTED', 'OPS_REVIEW_REQUIRED', 'COMPLETED', 'CLOSED'],
  OPS: ['OPS_REVIEW_REQUIRED', 'COMPLETED', 'CLOSED'],
}
