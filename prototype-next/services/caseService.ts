...
import { classify, classifySectors } from '@/services/segmentClassifier'
import { buildDocuments } from '@/services/documentRequirements'
import { canTransition, STATUS_LABELS, ROLE_LABELS } from '@/services/stateMachine'
...
// ── Read helpers (components can also subscribe to stores directly) ──────────
