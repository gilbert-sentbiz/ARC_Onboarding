  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ background: 'var(--sb-n50)' }}>
      ...
      <div className="w-full max-w-[640px] flex flex-col gap-4">
                  ...
                  <div className="flex flex-col items-center">
                    {state === 'done' ? (
                      ...
                      <div
                        ...
                        style={{ borderColor: 'var(--sb-brand)', background: 'var(--sb-blue-100)' }}
                      />
                    ) : (
                    ...
                    {!isLast && (
                      <div
                        ...
                        style={{ background: state === 'done' ? 'var(--sb-brand)' : 'var(--sb-n200)' }}
                      />
                    )}
                  </div>
              ...
              {sortedHistory.map((h) => (
                <div key={h.id} className="flex items-start justify-between gap-4">
                  <div className="min-w-0">
                    ...
                    {h.notes && (
                      <p className="text-[11px] mt-0.5" style={{ color: 'var(--sb-n400)' }}>{h.notes}</p>
                    )}
                  </div>
        ...
        >
          {/* 헤더 */}
          <div className="flex items-center gap-2 px-6 py-4 border-b" style={{ borderColor: 'var(--sb-n100)' }}>
            <ChatCircle size={17} weight="fill" style={{ color: 'var(--sb-brand)' }} />
            <p className="text-[13px] font-semibold" style={{ color: 'var(--sb-n700)' }}>담당자와 메시지</p>
          </div>
          ...
          {/* 입력 */}
          <div className="px-4 pb-4 flex gap-2 border-t pt-3" style={{ borderColor: 'var(--sb-n100)' }}>
            <textarea
              value={msgText}
