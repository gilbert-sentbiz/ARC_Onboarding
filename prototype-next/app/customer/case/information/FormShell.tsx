  ...
  return (
    <div className="min-h-screen flex flex-col items-center px-4 py-8" style={{ background: 'var(--sb-n50)' }}>
      <div className="w-full max-w-[680px] mb-6">
        <div className="flex items-center justify-between mb-5">
          ...
          <div className="flex items-center gap-4">
            ...
            <span className="text-[13px] font-medium" style={{ color: 'var(--sb-n500)' }}>{step + 1} / {totalSteps}</span>
          </div>
        </div>
      ...
      <div className="w-full max-w-[680px] bg-white rounded-[16px] p-8 flex flex-col gap-7" style={{ boxShadow: 'var(--shadow-200)' }}>
        <div>
          <p className="text-[12px] font-semibold tracking-[1px] uppercase mb-1" style={{ color: 'var(--sb-brand)' }}>2차 정보 입력</p>
          <h2 className="text-[20px] font-bold" style={{ color: 'var(--sb-n900)' }}>{titles[step]}</h2>
        </div>
        {children}
      </div>
    </div>
