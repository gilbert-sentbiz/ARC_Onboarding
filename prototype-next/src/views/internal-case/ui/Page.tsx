...
const STATUS_BADGE: Record<CaseStatus, { cls: string; style?: React.CSSProperties }> = {
  ...
  SALES_REVIEW_REQUIRED: { cls: 'bg-amber-50 text-amber-600' },
  COMPLIANCE_REVIEW_REQUIRED: { cls: 'bg-purple-50 text-purple-600' },
  REVISION_REQUESTED: { cls: 'bg-orange-50 text-orange-600' },
  OPS_REVIEW_REQUIRED: { cls: 'bg-cyan-50 text-cyan-700' },
        ...
        if (typeof val === 'object' && !Array.isArray(val)) {
          return (
            <div key={key}>
              ...
              <div className="pl-3 border-l-2" style={{ borderColor: 'var(--sb-n100)' }}>
            ...
            {c.currentOwner?.role !== 'CUSTOMER' && c.currentOwner && (
              <div className="flex items-center gap-1.5 flex-shrink-0 ml-2">
                ...
                {ownerChangeMode ? (
                  ...
                  <>
                    <span className="text-[12px] font-medium" style={{ color: 'var(--sb-n800)' }}>
                      {c.currentOwner.name}
                    </span>
                    <button
      ...
      <div className="flex-1 max-w-[1200px] mx-auto w-full px-6 py-8 pb-36">
        ...
        {tab === 'info' && (
          <div className="flex flex-col gap-6 max-w-[800px]">
            ...
            >
              <h3 className="text-[14px] font-semibold" style={{ color: 'var(--sb-n900)' }}>
                1차 입력 정보
              </h3>
              ...
              <>
                <div className="flex items-center justify-between">
                  ...
                  (c.documents ?? []).some((d) => d.status === 'SUBMITTED') ? (
                    <button
                      ...
                      className="flex items-center gap-1.5 px-3 py-2 rounded-[8px] text-[13px] font-medium hover:opacity-80 transition-opacity"
                      style={{
                        background: 'var(--sb-positive-light)',
                        color: 'var(--sb-positive)',
                      }}
                    >
                      ...
                      return (
                        <div className="flex items-center gap-2">
                          ...
                          <button
                            ...
                            className="flex items-center gap-1.5 px-3 py-2 rounded-[8px] text-[13px] font-medium transition-colors"
                            style={{ border: '1px solid var(--sb-n200)', color: 'var(--sb-n700)' }}
                          >
                ...
                {showAdHocForm && (
                  <div className="bg-blue-50 rounded-[12px] border border-blue-200 p-5 flex flex-col gap-3">
                    <p className="text-[13px] font-semibold" style={{ color: 'var(--sb-n900)' }}>
                      서류 추가 요청
                    </p>
                    <div className="flex flex-col gap-2">
                      <input
                        className="rounded-[8px] px-3 py-2 text-[13px] focus:outline-none bg-white"
                        style={{ border: '1px solid var(--sb-n200)', color: 'var(--sb-n800)' }}
                        placeholder="서류명 (필수)"
                    ...
                    >
                                    ...
                                    <div className="flex items-center gap-2">
                                      ...
                                      >
                                        ...
                                        <span
                                          ...
                                          style={{ color: 'var(--sb-n400)' }}
                                        >
                                          {formatDate(latestFile.uploadedAt)}
                                        </span>
                                      </button>
                                      {latestFile.dataUrl && (
                                        <button
                                          ...
                                          style={{ color: 'var(--sb-n400)' }}
                                          onMouseEnter={(e) =>
                                            (e.currentTarget.style.color = 'var(--sb-n700)')
                                          }
                                          onMouseLeave={(e) =>
                                            (e.currentTarget.style.color = 'var(--sb-n400)')
                                          }
                                        >
                        ...
                        <div className="flex items-center gap-2 flex-shrink-0">
                          <span
                            className={`px-2 py-0.5 rounded-full text-[11px] font-medium ${
                              doc.status === 'NOT_REQUESTED' || doc.status === 'APPROVED'
                                ? ''
                                : badge.cls
                            }`}
                            style={badgeStyle}
                      ...
                      {isRevisionOpen && (
                        <div
                          ...
                          style={{ borderTop: '1px solid var(--sb-n100)' }}
                        >
                          <input
          ...
          <div className="grid grid-cols-[1fr_360px] gap-6 max-w-[1100px]">
            ...
            <div className="flex flex-col gap-4">
              <div
                ...
                style={{ border: '1px solid var(--sb-n100)' }}
              >
                <h3 className="text-[14px] font-semibold mb-4" style={{ color: 'var(--sb-n900)' }}>
                  상태 변경 이력
                </h3>
                        ...
                        <div className="flex flex-col items-center">
                          ...
                          >
                            {i === 0 ? (
                              ...
                              <span className="text-[10px]" style={{ color: 'var(--sb-n500)' }}>
                                ↔
                              </span>
                            ) : (
            ...
            <div className="flex flex-col gap-4">
              ...
              >
                ...
                <div className="flex flex-col gap-2 max-h-[240px] overflow-y-auto">
                  {(c.messages ?? []).length === 0 ? (
                    <p className="text-[12px] text-center py-4" style={{ color: 'var(--sb-n400)' }}>
                      메시지가 없습니다.
                    </p>
                  ) : (
                    (c.messages ?? []).map((msg) => {
                      ...
                      return (
                        ...
                        >
                          <span className="text-[10px]" style={{ color: 'var(--sb-n400)' }}>
                            {msg.sender.name}
                          </span>
                          <div
              ...
              >
                ...
                >
                  <Note size={15} />
                  내부 노트{' '}
                  <span className="text-[11px] font-normal" style={{ color: 'var(--sb-n400)' }}>
                    (고객 비공개)
                  </span>
                </h3>
            ...
            {pendingAction && (
              <div className="flex gap-2 items-start">
                {pendingAction.isConfirmOnly ? (
                  <>
                    <p
                      className="flex-1 text-[13px] self-center"
                      style={{ color: 'var(--sb-n700)' }}
                    >
                  ...
                  style={
                    action.variant === 'primary'
                      ? {
                          background: 'var(--sb-brand)',
                          color: 'white',
                          ...(pendingAction?.label === action.label
                            ? { outlineColor: 'var(--sb-brand)' }
                            : {}),
                        }
      ...
      {previewFile && (
        ...
        >
          ...
          >
            ...
            >
              <span
                className="text-[14px] font-medium truncate pr-4"
                style={{ color: 'var(--sb-n900)' }}
              >
            ...
            <div className="flex-1 overflow-auto p-5 flex items-center justify-center min-h-[300px]">
              {previewFile.dataUrl && previewFile.dataUrl.startsWith('data:image') ? (
                ...
                <div className="flex flex-col items-center gap-3 text-center">
                  ...
                  <p className="text-[12px]" style={{ color: 'var(--sb-n400)' }}>
                    미리보기를 지원하지 않는 파일입니다.
                  </p>
                </div>
              )}
