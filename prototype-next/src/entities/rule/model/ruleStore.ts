...
export const INITIAL_RULESET: RuleSet = {
  ...
  documentRules: [
      ...
      docs: [
        {
          ...
          displayName: '사업자등록증 (Business Registration Certificate)',
          isRequired: true,
          isConditional: false,
        },
        {
        ...
        },
        {
          ...
          displayName: '주주명부 (Shareholder List)',
          isRequired: true,
          isConditional: false,
        },
        {
          type: 'id_copy',
          displayName: '대표자 신분증 사본 (CEO ID Copy, 공동대표 전원)',
          isRequired: true,
          isConditional: false,
        },
        {
        ...
        {
          type: 'bank_account',
          displayName: '은행계좌 사본 (Bank Account Copy)',
          isRequired: true,
          isConditional: false,
        },
        {
          type: 'contract',
          displayName: '계약서 — 거래처 (Contract)',
          isRequired: true,
          isConditional: false,
        },
        {
          type: 'sample_invoice_shipping',
          displayName: '샘플 인보이스 및 선적자료 (Sample Invoice & Shipping Docs)',
          isRequired: true,
          isConditional: false,
        },
        {
          type: 'website_url',
          displayName: '홈페이지 주소 (Website URL)',
          isRequired: false,
          isConditional: true,
        },
      ],
    },
    {
      ...
      docs: [
        ...
        {
          type: 'id_copy',
          displayName: '대표자 신분증 사본 (Representative ID Copy)',
          isRequired: true,
          isConditional: false,
        },
        {
    ...
    },
    {
      ...
      docs: [
        ...
        {
          type: 'remittance_license',
          displayName: 'Remittance License (또는 동등 인허가)',
          isRequired: true,
          isConditional: false,
        },
        {
          type: 'internal_policies',
          displayName: 'Internal Policies (Compliance/Risk)',
          isRequired: true,
          isConditional: false,
        },
        {
        ...
        },
        {
          ...
          displayName: 'Ownership Chart',
          isRequired: true,
          isConditional: false,
        },
        {
          type: 'director_list',
          displayName: 'List of Directors',
          isRequired: true,
          isConditional: false,
        },
        {
          type: 'id_copy',
          displayName: 'Certified ID Copies — 이사 전원 + UBO 25%+',
          isRequired: true,
          isConditional: false,
        },
        {
        ...
        {
          type: 'bank_proof',
          displayName: 'Proof of Bank Account (최근 3개월 내)',
          isRequired: true,
          isConditional: false,
        },
      ],
    ...
    // ── KRW Collection base ─────────────────────────────────────────────────
    {
      ...
      docs: [
        {
          type: 'biz_registration',
          displayName: 'Certificate of Business Registration',
          isRequired: true,
          isConditional: false,
        },
        {
        ...
        {
          type: 'shareholder_list',
          displayName: 'List of Shareholders',
          isRequired: true,
          isConditional: false,
        },
        {
        ...
        {
          type: 'id_copy',
          displayName: 'ID Copies — CEO, 이사, UBO 25%+',
          isRequired: true,
          isConditional: false,
        },
        {
          type: 'krw_bank_statement',
          displayName: 'Bank/E-wallet Statement (회사명 기재)',
          isRequired: true,
          isConditional: false,
        },
      ],
    ...
    // ── KRW sector-specific ─────────────────────────────────────────────────
    {
      ...
      docs: [
        {
          type: 'krw_sec_shipping',
          displayName: '선적서류 (B/L 등)',
          isRequired: true,
          isConditional: false,
        },
        {
          type: 'krw_sec_trade_lic',
          displayName: '수출입 신고서 / 라이센스',
          isRequired: true,
          isConditional: false,
        },
        {
          type: 'krw_sec_invoice',
          displayName: '샘플 수출 인보이스',
          isRequired: true,
          isConditional: false,
        },
      ],
    },
    {
      ...
      docs: [
        {
          type: 'krw_sec_logistics',
          displayName: '물류 전표',
          isRequired: true,
          isConditional: false,
        },
        {
          type: 'krw_sec_platform',
          displayName: '온라인 플랫폼 판매 기록 스크린샷',
          isRequired: true,
          isConditional: false,
        },
        {
    ...
    },
    {
      ...
      docs: [
        {
          type: 'krw_sec_contract',
          displayName: '고객 계약서 (업무범위)',
          isRequired: true,
          isConditional: false,
        },
        {
          type: 'krw_sec_report',
          displayName: '컨설팅 보고서 / 산출물 샘플',
          isRequired: true,
          isConditional: false,
        },
        {
          type: 'krw_sec_portfolio',
          displayName: '포트폴리오',
          isRequired: true,
          isConditional: false,
        },
    ...
    },
    {
      ...
      docs: [
        {
          type: 'krw_sec_contract',
          displayName: '고객 계약서 (기술 스펙)',
          isRequired: true,
          isConditional: false,
        },
        {
          type: 'krw_sec_project',
          displayName: '프로젝트 기획서 또는 진행 스크린샷',
          isRequired: true,
          isConditional: false,
        },
        {
    ...
    },
    {
      ...
      docs: [
        ...
        {
          type: 'krw_sec_ad_output',
          displayName: '광고 산출물 또는 광고 플랫폼 스크린샷',
          isRequired: true,
          isConditional: false,
        },
        {
          type: 'krw_sec_proposal',
          displayName: '마케팅 제안서',
          isRequired: true,
          isConditional: false,
        },
    ...
    },
    {
      ...
      docs: [
        ...
        {
          type: 'krw_sec_sw_doc',
          displayName: '소프트웨어 / 시스템 문서',
          isRequired: true,
          isConditional: false,
        },
        {
          type: 'krw_sec_deploy',
          displayName: '배포 증빙 스크린샷',
          isRequired: true,
          isConditional: false,
        },
      ],
    },
    {
      ...
      docs: [
        {
          type: 'krw_sec_seller_url',
          displayName: 'Coupang 셀러 URL / 판매이력',
          isRequired: true,
          isConditional: false,
        },
        {
          type: 'krw_sec_settlement',
          displayName: 'Coupang 정산서',
          isRequired: true,
          isConditional: false,
        },
        {
          type: 'krw_sec_service_agree',
          displayName: 'Service Agreement (Sunrate/Payful)',
          isRequired: true,
          isConditional: false,
        },
      ],
    ...
    // ── VND Collection ──────────────────────────────────────────────────────
    {
      ...
      docs: [
        ...
        {
          type: 'vnd_company_charter',
          displayName: 'Company Charter',
          isRequired: false,
          isConditional: true,
        },
        {
          type: 'vnd_incorporation',
        ...
        {
          type: 'shareholder_list',
          displayName: "Shareholders' Chart (25%+ 전원)",
          isRequired: true,
          isConditional: false,
        },
        {
          type: 'id_copy',
          displayName: 'Passport/ID Copy — UBO, 이사, 대표자',
          isRequired: true,
          isConditional: false,
        },
        {
          type: 'vnd_board_resolution',
          displayName: 'Board Resolution (서명자가 법적 대표가 아닌 경우)',
          isRequired: false,
          isConditional: true,
        },
        {
          type: 'vnd_licenses',
          displayName: 'Licenses (해당 시)',
          isRequired: false,
          isConditional: true,
        },
        {
          type: 'vnd_address',
          displayName: 'Address of UBOs, Directors, Reps, Shareholders',
          isRequired: true,
          isConditional: false,
        },
        {
          type: 'vnd_bank_statement',
          displayName: 'Bank Statement (SentBe App 사용자만)',
          isRequired: false,
          isConditional: true,
        },
        {
        ...
        {
          type: 'sample_invoice_shipping',
          displayName: 'Sample Shipping Documents',
          isRequired: true,
          isConditional: false,
        },
        {
          type: 'vnd_accountant_id',
          displayName: "Accountant's ID (베트남 법인만)",
          isRequired: false,
          isConditional: true,
        },
        {
          type: 'vnd_accountant_addr',
          displayName: "Accountant's Proof of Address (베트남 법인만)",
          isRequired: false,
          isConditional: true,
        },
        {
          type: 'vnd_office_photo',
          displayName: 'Office Photo with Company Logo',
          isRequired: false,
          isConditional: true,
        },
        {
          type: 'vnd_website_image',
          displayName: 'Image of Product/Service Website',
          isRequired: false,
          isConditional: true,
        },
      ],
    ...
    // ── Payout / Other ──────────────────────────────────────────────────────
    {
      ...
      docs: [
        {
          type: 'remittance_contract',
          displayName: '해외 송금 계약서 또는 거래 계획서',
          isRequired: false,
          isConditional: true,
        },
      ],
    },
    {
      ...
      docs: [
        {
          type: 'other_account',
          displayName: '해외 수금 계좌 정보',
          isRequired: true,
          isConditional: false,
        },
        {
          type: 'transaction_structure',
          displayName: '거래 구조 설명서',
          isRequired: true,
          isConditional: false,
        },
      ],
  ...
  docLibrary: [
    ...
    {
      type: 'DIRECTOR_LIST',
      displayName: '이사명부 (Director List)',
      isRequired: true,
      isConditional: false,
      classification: 'common',
    },
    ...
    {
      type: 'SAMPLE_INVOICE_SHIPPING',
      displayName: '샘플 인보이스 및 선적자료 (Sample Invoice & Shipping)',
      isRequired: true,
      isConditional: false,
      classification: 'common',
    },
  ...
  entityClassificationRules: [
    {
      ...
      priority: 1,
      conditions: [{ field: 'businessType', op: 'eq', value: 'financial' }],
      conditionLogic: 'AND',
      result: 'ENTITY_FI',
    },
    {
  ...
  questionPool: [
    ...
    },
    {
      ...
      children: [
        ...
        {
          id: 'qc_vasp_outside_lic',
          label: '설립/인허가 국가 외 고객을 온보딩하나요?',
          inputType: 'radio',
          isRequired: true,
          classification: 'common',
          showWhen: { parentId: 'qc_virtual_asset', value: 'yes' },
        ...
        {
          id: 'qc_vasp_cust_country',
          label: '해당 고객의 거주 국가를 입력해주세요',
          inputType: 'text',
          isRequired: true,
          classification: 'common',
          showWhen: { parentId: 'qc_vasp_outside_lic', value: 'yes' },
        },
        {
          id: 'qc_vasp_lic_used',
          label: '비거주 고객 온보딩에 사용하는 인허가를 입력해주세요',
          inputType: 'text',
          isRequired: true,
          classification: 'common',
          showWhen: { parentId: 'qc_vasp_outside_lic', value: 'yes' },
        ...
        {
          id: 'qc_vasp_purpose',
          label: '가상자산 출금·법정화폐 전환 요청의 주요 목적을 입력해주세요',
          inputType: 'text',
          isRequired: true,
          classification: 'common',
          showWhen: { parentId: 'qc_virtual_asset', value: 'yes' },
    ...
    },
    {
      ...
      isFixed: true,
      options: [
        { value: 'profit', label: '영리법인' },
        { value: 'nonprofit', label: '비영리법인(단체)' },
      ],
    },
    {
      id: 'qe_corp_reg_no',
      label: '법인 등록번호를 입력해주세요',
      inputType: 'text',
      isRequired: true,
      classification: 'entity-own',
      scope: 'ENTITY_CORP',
    ...
    },
    {
      ...
      children: [
        {
          id: 'qe_corp_rep_count',
          label: '공동대표 인원 수를 입력해주세요',
          inputType: 'number',
          isRequired: true,
          classification: 'entity-own',
          scope: 'ENTITY_CORP',
    ...
    },
    {
      ...
      isFixed: true,
      repeat: true,
      addButtonLabel: '대표자 추가하기',
      children: [
        {
          id: 'qe_corp_rep_name_kr',
          label: '성명 (한글)',
          inputType: 'text',
          isRequired: true,
          classification: 'entity-own',
    ...
    },
    {
      ...
      isFixed: true,
      repeat: true,
      addButtonLabel: '실제 소유자(BO) 추가하기',
      showWhen: { parentId: 'qe_corp_bo_exempt', value: 'none' },
      children: [
        {
          id: 'qe_corp_bo_name_kr',
          label: '성명 (한글)',
          inputType: 'text',
          isRequired: true,
          classification: 'entity-own',
    ...
    {
      id: 'qe_corp_founded_date',
      label: '회사 설립일자를 입력해주세요',
      inputType: 'text',
      isRequired: true,
      classification: 'entity-own',
      scope: 'ENTITY_CORP',
    ...
    },
    {
      ...
      children: [
        {
          id: 'qe_indiv_bo_name_kr',
          label: '실제 소유자 성명 (한글)',
          inputType: 'text',
          isRequired: true,
          classification: 'entity-own',
          scope: 'ENTITY_INDIV',
          showWhen: { parentId: 'qe_indiv_bo_same', value: 'no' },
        },
        {
          id: 'qe_indiv_bo_name_en',
          label: '실제 소유자 성명 (영문)',
          inputType: 'text',
          isRequired: true,
          classification: 'entity-own',
    ...
    {
      id: 'qe_fi_legal_form',
      label: '법적 형태를 입력해주세요 (예: 주식회사, 합자회사 등)',
      inputType: 'text',
      isRequired: true,
      classification: 'entity-own',
      scope: 'ENTITY_FI',
    ...
    {
      id: 'qe_fi_license_info',
      label: '인허가 기관 및 관할 국가를 입력해주세요',
      inputType: 'text',
      isRequired: true,
      classification: 'entity-own',
      scope: 'ENTITY_FI',
    ...
    {
      id: 'qe_fi_license_detail',
      label: '인허가 유형, 발급일, 만료일을 입력해주세요',
      inputType: 'text',
      isRequired: true,
      classification: 'entity-own',
      scope: 'ENTITY_FI',
    ...
    // Section B — 센트비 이용 서비스
    {
      ...
      isFixed: true,
      options: [
        { value: 'collection', label: '수금(Collection)' },
        { value: 'payout', label: '송금(Payout)' },
      ],
    },
    {
      ...
      children: [
        {
          id: 'qe_fi_intermediary_levels',
          label: '몇 단계의 중개 구조인가요?',
          inputType: 'text',
          isRequired: true,
          classification: 'entity-own',
          scope: 'ENTITY_FI',
          showWhen: { parentId: 'qe_fi_intermediary', value: 'yes' },
        },
        {
          id: 'qe_fi_unlic_psp',
          label: '미인가 FI/PSP/MSB와 거래하나요?',
          inputType: 'radio',
          isRequired: true,
          classification: 'entity-own',
          scope: 'ENTITY_FI',
    ...
    // Section D — 소유 구조
    {
      id: 'qe_fi_parent_name',
      label: '모회사 또는 최종 모회사 명칭을 입력해주세요',
      inputType: 'text',
      isRequired: true,
      classification: 'entity-own',
      scope: 'ENTITY_FI',
    ...
    {
      id: 'qe_fi_parent_address',
      label: '모회사 주소를 입력해주세요',
      inputType: 'text',
      isRequired: true,
      classification: 'entity-own',
      scope: 'ENTITY_FI',
    ...
    {
      id: 'qe_fi_aml_sanction',
      label: 'AML 위반으로 행정/금전적 제재를 받은 적이 있나요?',
      inputType: 'radio',
      isRequired: true,
      classification: 'entity-own',
      scope: 'ENTITY_FI',
    ...
    {
      id: 'qs_vnd_biz_reg_no',
      label: '사업자등록번호를 입력해주세요 (UEN/NIB/ERC)',
      inputType: 'text',
      isRequired: true,
      classification: 'service-own',
      scope: 'SVC_COL_VND',
    ...
    {
      id: 'qs_vnd_contact_name',
      label: '담당자 이름을 입력해주세요',
      inputType: 'text',
      isRequired: true,
      classification: 'service-own',
      scope: 'SVC_COL_VND',
    ...
    {
      id: 'qs_vnd_contact_phone',
      label: '담당자 연락처를 입력해주세요',
      inputType: 'text',
      isRequired: true,
      classification: 'service-own',
      scope: 'SVC_COL_VND',
    ...
    {
      id: 'qs_vnd_contact_email',
      label: '담당자 이메일을 입력해주세요',
      inputType: 'text',
      isRequired: true,
      classification: 'service-own',
      scope: 'SVC_COL_VND',
    ...
    {
      id: 'qs_vnd_biz_entity_type',
      label: '사업자 유형을 선택해주세요',
      inputType: 'text',
      isRequired: true,
      classification: 'service-own',
      scope: 'SVC_COL_VND',
    ...
    {
      id: 'qs_vnd_biz_activity',
      label: '주요 사업 활동을 입력해주세요',
      inputType: 'textarea',
      isRequired: true,
      classification: 'service-own',
      scope: 'SVC_COL_VND',
    ...
    {
      id: 'qs_vnd_monthly_volume',
      label: '예상 월간 거래 규모를 입력해주세요',
      inputType: 'text',
      isRequired: true,
      classification: 'service-own',
      scope: 'SVC_COL_VND',
    ...
    {
      id: 'qs_vnd_account_purpose',
      label: '계좌 개설 목적을 입력해주세요',
      inputType: 'textarea',
      isRequired: true,
      classification: 'service-own',
      scope: 'SVC_COL_VND',
    ...
    {
      id: 'qs_vnd_payer_relation',
      label: '입금자와의 관계를 입력해주세요',
      inputType: 'text',
      isRequired: true,
      classification: 'service-own',
      scope: 'SVC_COL_VND',
  ...
  firstIntakeQuestions: [
    ...
    {
      id: 'fi_collection_countries',
      label: '수금 국가',
      inputType: 'select',
      isRequired: true,
      classification: 'common',
      enabled: true,
      showWhen: { parentId: 'fi_services', value: 'collection' },
      hint: 'if 서비스=수금',
    },
    {
      id: 'fi_collection_other',
      label: '기타 수금 국가',
      inputType: 'text',
      isRequired: false,
      classification: 'common',
      enabled: true,
      showWhen: { parentId: 'fi_collection_countries', value: 'OTHER' },
      hint: 'if 수금 국가=기타',
    },
    {
      id: 'fi_remittance_from',
      label: '송금 출발 국가',
      inputType: 'select',
      isRequired: true,
      classification: 'common',
      enabled: true,
      showWhen: { parentId: 'fi_services', value: 'remittance' },
      hint: 'if 서비스=송금',
    },
    {
      id: 'fi_remittance_to',
    ...
    (set, get) => ({
      ...
      updateRuleSet: (next) => {
        ...
        set({
          ...
          history: [
            ...get().history,
            { version: prev.version, savedAt: Date.now(), ruleSet: prev },
          ],
        })
      },
    }),
...
function mergeSegDocConfigs(
  ...
  const initialByKey: Record<string, DocSegmentConfig> = Object.fromEntries(
    initial.map((c) => [c.key, c])
  )
...
export function getRuleSet(): RuleSet {
  ...
  const hasNewEntityRules =
    rs.entityClassificationRules?.length > 0 &&
  ...
  const hasNewServiceRules =
    rs.serviceClassificationRules?.length > 0 &&
    'triggerCountries' in (rs.serviceClassificationRules[0] ?? {})
  // Detect canonical document types; fall back if old localStorage still has pre-canonical codes
  const hasCanonicalDocTypes = !rs.documentRules?.some((r) =>
    r.docs.some((d) => d.type === 'id_card' || d.type === 'fi_biz_registration')
  )
  // Detect unified VASP common question (qc_vasp_outside_lic added in PI-64 rev2)
  const hasUnifiedVasp = rs.questionPool
    ?.find((q: { id: string }) => q.id === 'qc_virtual_asset')
    ?.children?.some((c: { id: string }) => c.id === 'qc_vasp_outside_lic')
  return {
    ...rs,
    entityClassificationRules: hasNewEntityRules
      ? rs.entityClassificationRules
      : INITIAL_RULESET.entityClassificationRules,
    serviceClassificationRules: hasNewServiceRules
      ? rs.serviceClassificationRules
      : INITIAL_RULESET.serviceClassificationRules,
    questionPool:
      rs.questionPool?.length && hasUnifiedVasp ? rs.questionPool : INITIAL_RULESET.questionPool,
    segmentQuestionConfigs: rs.segmentQuestionConfigs?.length
      ? rs.segmentQuestionConfigs
      : INITIAL_RULESET.segmentQuestionConfigs,
    documentRules: hasCanonicalDocTypes ? rs.documentRules : INITIAL_RULESET.documentRules,
    firstIntakeQuestions: rs.firstIntakeQuestions?.length
      ? rs.firstIntakeQuestions
      : INITIAL_RULESET.firstIntakeQuestions,
